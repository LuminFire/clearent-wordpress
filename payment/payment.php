...
class payment {
	...
	public function clearent_pay_form( $atts, $content, $tag ) {
		...
		if ( is_bool( $a[ 'customer-id' ] ) && $a[ 'customer-id' ] != FALSE ) {
			...
			if ( ! is_bool( $a[ 'customer-id' ] ) && isset( $a[ 'customer-id' ] ) ) {
		...
		if ( is_bool( $a[ 'invoice' ] ) && $a[ 'invoice' ] != FALSE ) {
			...
			if ( ! is_bool( $a[ 'invoice' ] ) && isset( $a[ 'invoice' ] ) ) {
		...
		if ( is_bool( $a[ 'purchase-order' ] ) && $a[ 'purchase-order' ] != FALSE ) {
			...
			if ( ! is_bool( $a[ 'purchase-order' ] ) && isset( $a[ 'purchase-order' ] ) ) {
		...
		if ( is_bool( $a[ 'email-address' ] ) && $a[ 'email-address' ] != FALSE ) {
			...
			if ( ! is_bool( $a[ 'email-address' ] ) && isset( $a[ 'email-address' ] ) ) {
		...
		if ( is_bool( $a[ 'order-id' ] ) && $a[ 'order-id' ] != FALSE ) {
			...
			if ( ! is_bool( $a[ 'order-id' ] ) && isset( $a[ 'order-id' ] ) ) {
		...
		if ( is_bool( $a[ 'description' ] ) && $a[ 'description' ] != FALSE ) {
			...
			if ( ! is_bool( $a[ 'description' ] ) && isset( $a[ 'description' ] ) ) {
		...
		if ( is_bool( $a[ 'comments' ] ) && $a[ 'comments' ] != FALSE ) {
			...
			if ( ! is_bool( $a[ 'comments' ] ) && isset( $a[ 'comments' ] ) ) {
		...
		if ( is_bool( $a[ 'recurring-payment' ] ) && $a[ 'recurring-payment' ] != FALSE ) {
			...
			if ( ! is_bool( $a[ 'recurring-payment' ] ) && isset( $a[ 'recurring-payment' ] ) ) {
	...
	public function validate() {
		...
		if ( ! $_REQUEST[ "card" ] ) {
			...
			if ( strlen( preg_replace( "/[^0-9]/", "", $_REQUEST[ "card" ] ) ) < 13 || strlen( preg_replace( "/[^0-9]/", "", $_REQUEST[ "card" ] ) ) > 19 ) {
		...
		if ( is_bool( $_SESSION[ "clearent.require-csc" ] ) && $_SESSION[ "clearent.require-csc" ] != FALSE ) {
			...
			if ( strlen( $_REQUEST[ "csc" ] ) == 0 ) {
				...
				if ( isset( $_REQUEST[ "csc" ] ) && ! in_array( strlen( $_REQUEST[ "csc" ] ), [ 3, 4 ] ) ) {
			...
			if ( isset( $_REQUEST[ "csc" ] ) && ! in_array( strlen( $_REQUEST[ "csc" ] ), [ 0, 3, 4 ] ) ) {
